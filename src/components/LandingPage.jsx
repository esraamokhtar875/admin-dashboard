    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <Grid container spacing={4} justifyContent="center" style={{ marginTop: '30px' }}>
                {/* Left Statistic Card (Doubled width) */}
                <Grid item xs={12} sm={12} md={6}>  {/* Increased the width from md={3} to md={6} */}
                ...
                {/* Middle Statistic Card (Doubled width) */}
                <Grid item xs={12} sm={12} md={12}>  {/* Increased the width from md={6} to md={12} */}
                ...
                {/* Right Statistic Card (Doubled width) */}
                <Grid item xs={12} sm={12} md={6}>  {/* Increased the width from md={3} to md={6} */}
